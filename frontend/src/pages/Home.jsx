        ...
        <div className="max-w-5xl w-full space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col min-h-[320px]">
              ...
              <h3 className="text-base font-semibold text-gray-900 mb-1">{t('home.searchTitle')}</h3>
              <p className="text-sm text-gray-600">{t('home.searchDesc')}</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col min-h-[320px]">
              ...
              <h3 className="text-base font-semibold text-gray-900 mb-1">{t('home.bookTitle')}</h3>
              <p className="text-sm text-gray-600">{t('home.bookDesc')}</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col min-h-[320px]">
              ...
              <h3 className="text-base font-semibold text-gray-900 mb-1">{t('home.payTitle')}</h3>
              <p className="text-sm text-gray-600">{t('home.payDesc')}</p>
            </div>
